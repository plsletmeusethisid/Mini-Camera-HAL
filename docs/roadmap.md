...
| 2. Async request/result | Producer-consumer concurrency and safe shutdown | **Implemented:** callback API, bounded queue, lifecycle state machine, cancellation; TSan clean |
...
| 7. Metrics and benchmark | Measure-optimize-verify loop | **Implemented:** FPS, bounded rolling latency percentiles, pool high-water mark, checked-in runs |
